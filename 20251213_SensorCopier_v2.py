...
# --- 設定 ---
__version__ = "2.0.1"  # 最終調整版 (ファイル書き込みの原子性を強化)

# ログ設定
LOG_DIR = "/home/hideo_81_g/logs"
os.makedirs(LOG_DIR, exist_ok=True)

log_handlers = [logging.FileHandler(os.path.join(LOG_DIR, "sensor_copier_v2.log"))]
...
def needs_full_sync():
    ...
    if current_hour % FULL_SYNC_INTERVAL_HOURS == 0:
