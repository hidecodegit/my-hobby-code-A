...
# --- 設定 ---
__version__ = "5.2.0"  # v5.2.0: ロギング処理をクリーンアップ

# ログ設定
LOG_DIR = "/home/hideo_81_g/logs"
LOG_FILE = os.path.join(LOG_DIR, "sensor_copier_v5.log")
...
def restore_ram_from_persistent():
    ...
    elif os.path.exists(latest_path_ram) and os.path.getsize(latest_path_ram) == 0:
